...
\date{Presentation to the Mid-Kent Astronomical Society \\ 12 November 2021 \\ Optional interactive content: You are invited to go to \alert{\mentiurl{}} and enter code \menticode{}.}
...
\begin{frame}{Why does gravity play a role?}
  ...
  \itemandimageandcredit{Mass/Energy (remember that they are the same via $E=mc^2$) \textit{bends} spacetime, essentially changing distances and angles.}{800px-Spacetime_lattice_analogy.svg.png}{height=2cm}{Mysid}{-4}{-1.3}
  \end{itemize}
\end{frame}
...
\begin{frame}{Recession velocity vs distance relationship}
  \begin{columns}
    \column{0.4\linewidth}
    It was \Lemaitre{} who first suggested a linear relationship between recession velocity and distance.
    \column{0.6\linewidth}
    \centering
    \imageandcredit{MillikanLemaitreEinstein.jpg}{height=5.5cm}{Public domain}{-4}{-2.3}
  \end{columns}
\end{frame}


\begin{frame}{Extract from \Lemaitre{}'s paper of 1927}
%\includegraphics[height=4.5cm]{LemaitreExtract.jpg}
  \imageandcredit{LemaitreExtract.jpg}{height=4.5cm}{G. \Lemaitre{}}{0.5}{-2.8}
\end{frame}
...
\begin{frame}{Recession velocity vs distance relationship}
  \begin{columns}
    \column{0.4\linewidth}
    Hubble then provided supporting evidence - he used the 100 inch Hooker Telescope at Mt Wilson to spot Cepheids in a range of galaxies.
    \column{0.6\linewidth}
    \centering
    \imageandcredit{100_inch_Hooker_Telescope_900_px.jpg}{height=7cm}{Ken Spencer}{-4}{-3.7}
  \end{columns}
\end{frame}
...
%\includegraphics[height=6.8cm]{F2.large.jpg}
  \imageandcredit{F2.large.jpg}{height=6.8cm}{E. Hubble}{0.5}{-2.8}
\end{frame}
...
\begin{frame}{Falling estimates of $H_0$ 1920 - 1980}
    \imageandcredit{Trimble_HistoryOfHubbleConstant.png}{height=7cm}{V. Trimble}{1.65}{-2.3}
\end{frame}
