...
\begin{frame}{Why does gravity play a role?}
  ...
  \itemandimageandcredit{Mass/Energy (remember - they are the same - $E=mc^2$) \textit{bends} spacetime, essentially changing distances and angles.}{800px-Spacetime_lattice_analogy.svg.png}{height=2cm}{Mysid}{-4}{-1.3}
  \end{itemize}
\end{frame}
