...
\begin{frame}{The Universe is expanding!}
  ...
  \item{How do we know how fast it is expanding?}
...
%https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Leavitt_aavso.jpg/256px-Leavitt_aavso.jpg
...
\begin{frame}{Recession velocity vs distance relationship}
  \begin{itemize}
  % https://upload.wikimedia.org/wikipedia/commons/c/c6/MillikanLemaitreEinstein.jpg
    ...
    % https://www.npr.org/2015/04/25/401843663/hubbles-other-telescope-and-the-day-it-rocked-our-world?t=1636381997027
...
\begin{frame}{Falling estimates of $H_0$ 1920 - 1980}
  % https://iopscience.iop.org/article/10.1086/133837/meta
...
\begin{frame}{Distances had been underestimated}
   Several revisions (distance up, $H_0$ down) followed:
    \begin{enumerate}
      ...
      % https://mathshistory.st-andrews.ac.uk/Biographies/Scott_Elizabeth/Scott_Elizabeth.jpeg
...
\begin{frame}{Hubble Space Telescope}
 ...
 % By pollosaurio from Canada - Wendy Freedman, CC BY 2.0, https://commons.wikimedia.org/w/index.php?curid=50909535
...
\begin{frame}{More recent values - diverging opinion}
  \imageandcredit{Freedman_RecentHistoryOfH0.png}{height=7cm}{W. Freedman}{0}{-3.2}
\end{frame}
...
\begin{frame}{More recent values - diverging opinion}
  ...
  \imageandcredit{Freedman_RecentHistoryOfH0.png}{height=4cm}{W. Freedman}{1}{-1}
  \end{block}
  \begin{block}{}
  \begin{itemize}
...
\begin{frame}{$H_0$ from early Universe data}
  \begin{itemize}
  \item{For 300,000 years after the Big Bang, the Universe was opaque. Then it became transparent, and we can today observe (red-shifted) light from then (the \textit{Cosmic Microwave Background)}.}
  \item{The distance that light could travel in those 300,000 years can be seen statistically in these observations. Trigonometry then gives us the distance the light has travelled.}
...
\begin{frame}{Hubble tension}
  ...
  \begin{block}{}
  \begin{itemize}
  \item{Should we be worried by the discrepancy?}
  \item{It could require that a revision to our theory. But it might also just be a systematic error in one of the measurements.}
  \end{itemize}
  \end{block}
\end{frame}
