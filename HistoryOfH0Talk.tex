...
\begin{frame}{Distance measurements - Cepheids}
\begin{itemize}
\item{Cosmic distances can be estimated using variable stars called \textit{Cepheids}. We know how much light they produce (it's related to their period). Their observed brightness then tells us their distance.}
...
\begin{frame}{How distant is that Cepheid?}
  \begin{block}{}
...
\begin{frame}{Linear relationship between recession velocity and distance}
  \begin{itemize}
    \item{It was Lama\^itre who first suggested a linear relationship between recession velocity and distance.}
    \item{Hubble then provided supporting evidence - he used the 100 inch telescope at Mt Wilson to spot Cepheids in a range of galaxies.}
  \end{itemize}
\end{frame}
